                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            <div className="flex shrink-0 items-center gap-2">
                                <Link
                                    href="/"
                                    className="text-lg font-extrabold tracking-tight text-rtq-maroon"
                                >
                                    RTQ<span className="text-rtq-orange">+</span>
                                </Link>
                                <span className="hidden text-xs uppercase tracking-widest text-gray-400 sm:inline">
                                    Admin
                                </span>
                            </div>
                            ...
                            <div className="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    href={route('admin.fans.index')}
                                    active={route().current('admin.fans.*')}
                                >
                                    Fans
                                </NavLink>
                                <NavLink
                                ...
                                <NavLink
                                    href={route('admin.points-rules.index')}
                                    active={route().current('admin.points-rules.*')}
                                >
                                    Points Rules
                                </NavLink>
                                <NavLink
                                ...
                                <NavLink
                                    ...
                                    active={route().current('admin.redemptions.*')}
                                >
                                    Redemptions
                                </NavLink>
                                <NavLink
                                ...
                                <NavLink
                                    ...
                                    active={route().current('admin.game-sessions.*')}
                                >
                                    Game Sessions
                                </NavLink>
                                <NavLink
